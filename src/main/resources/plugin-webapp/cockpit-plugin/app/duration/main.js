...
// var instanceCount = require('src\main\resources\plugin-webapp\cockpit-plugin\app\demoText\brain.js');
...
define(['angular'], function(angular) {
    ...
    var ngModule = angular.module('cockpit.plugin.cockpit-plugin.diagram.duration', []);
