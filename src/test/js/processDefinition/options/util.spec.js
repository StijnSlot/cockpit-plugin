...
before(function(done) {
    requirejs(['main/resources/plugin-webapp/centaur/app/processDefinition/optionsTab/util'], function(utl) {
        util = utl;
        done();
    });
});

it('should find optionsTab util file for optionsTab tab', function() {
